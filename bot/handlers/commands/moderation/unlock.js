...
module.exports = {
  ...
  async execute(message, args) {
    ...
    try {
      ...
      console.error(err);
      return message
        .reply("I was unable to unlock this channel, please check my permissions and try again.\n" + err)
    ...
    const settings = await message.client.models.guild.findOne(
      ...
      async (err, settings) => {
        ...
        let lockembed = new MessageEmbed()
          ...
          .setTimestamp()
          .setFooter(`Unlocked by ${message.author.tag}`, message.author.displayAvatarURL());
