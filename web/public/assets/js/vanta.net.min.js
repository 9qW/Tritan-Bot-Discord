!(function (t, e) {
  ...
  return (function (t) {
    ...
    1: function (t, e, i) {
      ...
      (r.register = (t, e) => (r[t] = (t) => new e(t))), (r.version = "0.5.19");
      const h = function () {
      ...
      (r.VantaBase = class {
        constructor(t = {}) {
          ...
          const e =
            "function" == typeof this.getDefaultOptions ? this.getDefaultOptions() : this.defaultOptions;
          if (
          ...
          i("resize", this.resize),
            ...
            this.options.mouseControls &&
              (i("scroll", this.windowMouseMoveWrapper), i("mousemove", this.windowMouseMoveWrapper)),
            this.options.touchControls &&
              (i("touchstart", this.windowTouchWrapper), i("touchmove", this.windowTouchWrapper)),
    ...
    12: function (t, e, i) {
      ...
      class r extends s.b {
        ...
        onInit() {
          ...
          h.addAttribute("position", new n.BufferAttribute(this.linePositions, 3).setDynamic(!0)),
            h.addAttribute("color", new n.BufferAttribute(this.lineColors, 3).setDynamic(!0)),
          ...
          for (let i = 0; i <= t; i++)
            for (let s = 0; s <= t; s++) {
              ...
              i % 2 && (h += 0.5 * e),
                ...
                this.genPoint(r + Object(o.g)(-5, 5), n + Object(o.g)(5, 15), h + Object(o.g)(-5, 5));
            }
          (this.camera = new n.PerspectiveCamera(25, this.width / this.height, 0.01, 1e4)),
        ...
        onUpdate() {
          ...
          const r = new n.Color(this.options.backgroundColor),
            ...
            a = h.clone().sub(r);
          this.rayCaster &&
            this.rayCaster.setFromCamera(new n.Vector2(this.rcMouseX, this.rcMouseY), this.camera);
          for (let t = 0; t < this.points.length; t++) {
            let e, c;
            const l = this.points[t],
              u = (c = this.rayCaster ? this.rayCaster.ray.distanceToPoint(l.position) : 1e3).clamp(5, 15);
            if (((l.scale.x = l.scale.y = l.scale.z = (0.25 * (15 - u)).clamp(1, 100)), 0 !== l.r)) {
              let t = Math.atan2(l.position.z, l.position.x);
              (e = Math.sqrt(l.position.z * l.position.z + l.position.x * l.position.x)),
                (t += 25e-5 * l.r),
            ...
            for (let c = t; c < this.points.length; c++) {
              ...
              if ((e = Math.sqrt(u * u + p * p + d * d)) < this.options.maxDistance) {
                ...
                (c = "additive" === this.blending ? new n.Color(0).lerp(a, u) : r.clone().lerp(h, u)),
